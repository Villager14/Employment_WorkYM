...
UprightAnimationState::UprightAnimationState(AnimationManager* PlayerAnimation)
	:
	m_elapsedTime(0.0f),
	...
	std::vector<PlayerBonsInformation>* bonesInformation)
{
	...
	m_playerAnimation->GetCommonProcess()->AnimationMovement(BonsType::LArmUp, bonesInformation, DirectX::SimpleMath::Quaternion::Identity, (*bonesInformation)[BonsType::LArmUp].rotation, m_animationTransration);
	m_playerAnimation->GetCommonProcess()->AnimationMovement(BonsType::LArmDown, bonesInformation, DirectX::SimpleMath::Quaternion::Identity, (*bonesInformation)[BonsType::LArmDown].rotation, m_animationTransration);
	m_playerAnimation->GetCommonProcess()->AnimationMovement(BonsType::RArmUp, bonesInformation, DirectX::SimpleMath::Quaternion::Identity, (*bonesInformation)[BonsType::RArmUp].rotation, m_animationTransration);
	m_playerAnimation->GetCommonProcess()->AnimationMovement(BonsType::RArmDown, bonesInformation, DirectX::SimpleMath::Quaternion::Identity, (*bonesInformation)[BonsType::RArmDown].rotation, m_animationTransration);
