/*
* @file		CrouchingStayAnimationState.cpp
* @brief	しゃがみ待機のアニメーション
* @author	Morita
* @date		2024/06/25
*/
...
#include "CrouchingStayAnimationState.h"

#include "../../AnimationManager.h"


CrouchingStayAnimationState::CrouchingStayAnimationState(AnimationManager* PlayerAnimation)
	:
	m_elapsedTime(0.0f),
...
CrouchingStayAnimationState::~CrouchingStayAnimationState()
{
}

void CrouchingStayAnimationState::Initialize()
{
...
void CrouchingStayAnimationState::Update(float speed, DirectX::SimpleMath::Vector3 position,
...
void CrouchingStayAnimationState::Finalize()
{
}
