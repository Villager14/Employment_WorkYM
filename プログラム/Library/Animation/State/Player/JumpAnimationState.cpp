...
#include "JumpAnimationState.h"

#include "../../AnimationManager.h"


JumpAnimationState::JumpAnimationState(AnimationManager* PlayerAnimation)
	:
	m_elapsedTime(0.0f),
...
JumpAnimationState::~JumpAnimationState()
{
}

void JumpAnimationState::Initialize()
{
...
void JumpAnimationState::Update(float speed, DirectX::SimpleMath::Vector3 position,
...
void JumpAnimationState::Finalize()
{
}
