/*
* @file		WireJumpAnimationState.cpp
* @brief	ワイヤージャンプのアニメーション
* @author	Morita
* @date		2024/06/25
*/
...
#include "WireJumpAnimationState.h"

#include "../../AnimationManager.h"


WireJumpAnimationState::WireJumpAnimationState(AnimationManager* PlayerAnimation)
	:
	m_elapsedTime(0.0f),
...
WireJumpAnimationState::~WireJumpAnimationState()
{
}

void WireJumpAnimationState::Initialize()
{
...
void WireJumpAnimationState::Update(float speed, DirectX::SimpleMath::Vector3 position,
...
void WireJumpAnimationState::Finalize()
{
}
