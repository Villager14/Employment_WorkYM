...
class WallWalkAnimationState : public IAnimation
{
public:
	...
	*/
	WallWalkAnimationState(AnimationManager* PlayerAnimation);
	
	//		デストラクタ
	~WallWalkAnimationState();
