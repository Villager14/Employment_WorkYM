...
#include "HandGunStay.h"

#include "../../AnimationManager.h"

HandGunStay::HandGunStay(AnimationManager* PlayerAnimation)
	:
	m_elapsedTime(0.0f),
...
HandGunStay::~HandGunStay()
{
}

void HandGunStay::Initialize()
{
...
void HandGunStay::Update(float speed, DirectX::SimpleMath::Vector3 position, DirectX::SimpleMath::Vector2 angle, float height, std::vector<PlayerBonsInformation>* bonesInformation)
{
